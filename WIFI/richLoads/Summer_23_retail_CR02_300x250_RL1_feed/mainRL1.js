...
function animate() {
  ...
  .to(['.foregroundCloud'], 11, { x: -1000, ease: "none" }, 'frame1')

  .from('#emojiA', 0.3, {scale: 0, ease: Power4.easeIn}, 'frame1+=0.5')
  .from('#emojiB', 0.3, {scale: 0, ease: Power4.easeIn}, 'frame1+=3.5')
  .from('#emojiC', 0.3, {scale: 0, ease: Power4.easeIn}, 'frame1+=7.5')
  .from('#emojiD', 0.3, {scale: 0, ease: Power4.easeIn}, 'frame1+=10.5')

  .from('#emojiL', 0.3, {scale: 0, ease: Power4.easeIn}, 'frame1+=1.0')
  .from('#emojiM', 0.3, {scale: 0, ease: Power4.easeIn}, 'frame1+=2.5')
  .from('#emojiN', 0.3, {scale: 0, ease: Power4.easeIn}, 'frame1+=6.0')
  .from('#emojiO', 0.3, {scale: 0, ease: Power4.easeIn}, 'frame1+=8.5')
  ...
  .addLabel('frame_END', "frame1+=10.2")
