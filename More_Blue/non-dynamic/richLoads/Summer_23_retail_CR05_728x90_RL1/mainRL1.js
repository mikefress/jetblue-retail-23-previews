...
function animate() {
  ...
  tl.addLabel('frame1', 0)
    ...
    .to(['#h1', '#h2', '#plane'], 0.5, { autoAlpha: 0, ease: Power1.easeOut }, 'frame3+=2')
    ...
    .to(['#terms1', '#terms2'], 0.5, { color: '#0000AA', ease: Power1.easeOut}, 'frame_END+=0.1')
    .to('#h4', 0.5, { autoAlpha: 1, ease: Power1.easeOut}, 'frame_END+=0.5')
