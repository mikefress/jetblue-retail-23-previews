...
function animate() {
  ...
  tl.addLabel('start', 0)
    ...
    tl.to(['#man', '#man-2'], 9, { transform: "translate3d(0, 0, 1px) scale(1.1)", ease: Power1.easeInOut }, 0)
    tl.to(['#bkg'], 9, { transform: "translate3d(0, 0, 1px) scale(1.2)", ease: Power1.easeInOut }, 0)
}
